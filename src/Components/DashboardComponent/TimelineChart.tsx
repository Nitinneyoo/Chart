    ...
    <Card className="bg-white shadow-sm p-0">
      <CardContent className="p-6">
        ...
        <div className="relative mt-8">
          {/* Y-axis labels */}
          <div className="absolute left-0 text-xs text-gray-600 pr-4" style={{ top: "24px" }}>
            <div className="absolute flex items-center h-6" style={{ top: "16px" }}>Error</div>
            <div className="absolute flex items-center h-6" style={{ top: "56px" }}>Active</div>
            <div className="absolute flex items-center h-6" style={{ top: "96px" }}>Idle</div>
            <div className="absolute flex items-center h-6" style={{ top: "136px" }}>Charging</div>
            <div className="absolute flex items-center h-6" style={{ top: "176px" }}>Connected</div>
          </div>
