...
export default function peakActivityTimeline() {
	...
	const chartData =
		mockPeakActivityData[selectedRobot as keyof typeof mockPeakActivityData];
	const robotInfo =
		mockPeakActivityInfo[selectedRobot as keyof typeof mockPeakActivityInfo];
	return (
		<div className="space-y-6">
			...
			<div className="flex items-center gap-2 text-sm text-gray-600">
				...
				<span>
					You can analyse the number of requests processed in a given time
					interval
				</span>
			</div>
